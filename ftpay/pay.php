...
$notifyurl='http://'.$_POST['HTTP_HOST'].'/wxtpay/notify.php';
$returnurl='http://'.$_POST['HTTP_HOST'].'/wxtpay/return.php';
$remark='';
...
<body onLoad="document.pay.submit()">
    <form name="pay" action="http://pay.98nk.cn/apisubmit" method="post">
