    ...
    <div class="main-content">
        <div class="main-content-inner">
            <div class="page-content">
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <form class="form-horizontal" name="house_edit" id="house_edit" method="post" onsubmit="return checkForm();" action="/qyadmin.php/Land/house_edit">
                           <div class="form-group">
                                <label class="col-sm-2 control-label no-padding-right" for="form-field-1"> 房屋名：  </label>
                                <div class="col-sm-10">
                                    <input type="text" name="house_name" id="house_name" value="1级房屋" placeholder="输入房屋名" class="col-xs-10 col-sm-4" />
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="house_level" id="house_level" value="1" placeholder="输入房屋等级" class="col-xs-10 col-sm-4" />
                                    <span class="middle" id="resone"></span>
                                </div>
                            </div>
                              <div class="form-group">
                                <label class="col-sm-2 control-label no-padding-right" for="form-field-1"> 房屋参数：  </label>
                                <div class="col-sm-10">
                                  <textarea class="form-control" id="house_info" name="house_info" placeholder="输入参数信息" style="margin: 0px -0.015625px 0px 0px; height: 62px; width: 416px;"></textarea>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label no-padding-right" for="form-field-1">  房屋样式：  </label>
                                <div id="uploader-demo" class="webuploader_col">
                                    <!--用来存放item-->
                                    <div id="fileList" class="uploader-list">
                                        <div class="file-item upload-state-done">
                                            <img src="/Public/UploadFiles_s/2017-07-08/59609f56c7595.png" width="100">
                                        </div>
                                    </div>
                                    <input type="hidden" value="2017-07-08/59609f56c7595.png" id="uploader_file" name="uploader_file"/>
                                    <div id="filePicker">选择图片</div>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label no-padding-right" for="form-field-1"> 包含土地参数：  </label>
                                <div class="col-sm-10">
                                  <textarea class="form-control" id="house_info" name="house_tudi_info" placeholder="输入参数信息,例：{'gebi':'1','yanjian':'1','jiaoni':'1','jinsha':'1'}" style="margin: 0px -0.015625px 0px 0px; height: 62px; width: 416px;"></textarea>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label no-padding-right" for="form-field-1"> 描述：  </label>
                                <div class="col-sm-10">
                                    <textarea class="form-control" id="form-field-8" name="house_description" placeholder="输入描述" style="margin: 0px -0.015625px 0px 0px; height: 62px; width: 416px;">一级房屋</textarea>
                                </div>
                            </div>
