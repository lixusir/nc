                    ...
                    <div class="col-xs-12">
                        <div>
                            <div class="col-xs-12 col-sm-2">
                                <a href="/admin.php?m=user&a=member_head_add">
                                    <button class="btn btn-xs btn-info">添加头像</button>
                                </a>
                            </div>
                            <form id="leftnav" name="leftnav" method="post" action="" >
                                ...
                                <table id="dynamic-table" class="table table-striped table-bordered table-hover">
									...
									<?php if(is_array($info)): foreach($info as $key=>$v): ?><tr>
                                            ...
                                            <td> <img src="/Public/member_head_list/<?php echo ($v["id"]); ?>.png" width="50"></td>
                                            <td><?php echo ($v["head_description"]); ?></td>
                                        <td>
                                            <div class="hidden-sm hidden-xs action-buttons;display:none">
                                                <a class="green" href="/admin.php?m=user&a=member_head_edit&id=<?php echo ($v["id"]); ?>" title="修改">
    ...
    <script>
        function del(id) {
            layer.confirm('你确定要删除吗？', {icon: 3}, function (index) {
                layer.close(index);
                window.location.href = "/qyadmin.php/Member/member_head_del/del_id/" + id + "";
            });
        }
    </script>
    			<div class="footer">
