        ...
        <div class="main-content-inner">
            <div class="page-content">
                ...
                <script>
                    $(function () {
                        function checkForm() {
                            if ('' == $.trim($('#house_name').val())) {
                                $('#resone').attr("class", "middle highmsg");//ID为resone 重新class赋值
                                $('#resone').html('房屋名不能为空').show();//id为resone 赋值html值
                                $('#house_name').focus();
                                return false;
                            }
                        }
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <form class="form-horizontal" name="house_add" id="house_add" method="post" onsubmit="return checkForm();" action="/admin.php?m=user&a=house_add&act=1">
                            <div class="form-group">
                                <label class="col-sm-2 control-label no-padding-right" for="form-field-1"> 房屋名：  </label>
                                <div class="col-sm-10">
                                    <input type="text" name="house_name" id="house_name" placeholder="输入房屋名" class="col-xs-10 col-sm-4" />
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="house_level" id="house_level" placeholder="输入房屋等级" class="col-xs-10 col-sm-4" />
                                    <span class="middle" id="resone"></span>
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <textarea class="form-control" id="form-field-8" name="house_description" placeholder="输入简短介绍" style="margin: 0px -0.015625px 0px 0px; height: 62px; width: 416px;"></textarea>
                                </div>
                            </div>
