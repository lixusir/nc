                    ...
                    <div class="col-xs-12">
                        <div>
                            <div class="col-xs-12 col-sm-2">
                                <a href="/admin.php?m=user&a=notice_listadd">
                                    <button class="btn btn-xs btn-info">添加公告</button>
                                </a>
                            </div>
                                ...
                                <table id="dynamic-table" class="table table-striped table-bordered table-hover">
                                    ...
                                    <tbody>
                                     <?php if(is_array($info)): foreach($info as $key=>$v): ?><tr>
                                            ...
                                            <td><?php if($v['zt']==0){echo '关闭';}else{echo '开启';} ?></td>
                                        <td><input name="left_id[6]" value=" <?php echo ($v["sort"]); ?>" class="list_order"/></td>
                                        <td>
                                            <div class="hidden-sm hidden-xs action-buttons">
                                                <a class="green" href="/admin.php?m=user&a=notice_listedit&id=<?php echo ($v["id"]); ?>" title="修改">
                                    ...
                                    <tr>
                                        ...
                                        <td><button  id="btnorder" class="btn btn-white btn-yellow btn-sm" style="display:none;">排序</button></td>
                                        <td colspan="6" align="right"><div class=pagination><ul><li><span></span></li>          </ul></div></td>
                                    </tr>
                                    </tbody>
                                </table>
                            </form>
    ...
    <script>
        $(function () {
            $("#btnsubmit").click(function () {
                $('#checkk').attr('value', 1);
                $('#leftnav').attr("action", "/qyadmin.php/Notice/leftnavalldel.html");
            });

            $("#btnorder").click(function () {
                $('#checkk').attr('value', 0);
                $('#leftnav').attr("action", "/admin.php?=user&a=noticeorder");
            });
        });
        ...
        function del(id) {
            layer.confirm('你确定要删除吗？', {icon: 3}, function (index) {
                layer.close(index);
                window.location.href = "/admin.php?m=user&a=notice_del&id=" + id + "";
            });
        }
    </script>
