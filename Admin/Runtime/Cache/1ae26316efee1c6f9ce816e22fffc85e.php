                    ...
                    <div class="col-xs-12">
                        <div>
                            <div class="col-xs-12 col-sm-2">
                                <a href="/admin.php?m=user&a=house_add">
                                    <button class="btn btn-xs btn-info">添加房屋</button>
                                </a>
                            </div>
                                ...
                                <table id="dynamic-table" class="table table-striped table-bordered table-hover">
                                    <thead>
                                        <tr>
                                            ...
                                            <th width="8%">房屋等级</th>
                                            <th width="8%">房屋样式</th>
                                            <th width="12%">房屋参数设置</th>
                                            <th width="12%">土地参数设置</th>
                                            <th width="8%">描述</th>
									...
									<?php if(is_array($info)): foreach($info as $key=>$v): ?><tr>
                                            ...
                                            <td><?php echo ($v["house_level"]); ?></td>
                                            <td> <img src="/Public/house_list/<?php echo ($v["id"]); ?>.png" width="50"></td>
                                            <td><?php echo ($v["house_info"]); ?></td>
                                            <td><?php echo ($v["id"]); ?></td>
                                            <td><?php echo ($v["house_description"]); ?></td>
                                        <td>
                                            <div class="hidden-sm hidden-xs action-buttons" style="display:None;">
                                                <a class="green" href="/admin.php?m=user&a=house_edit/id/1.html" title="修改">
                                                    <i class="ace-icon fa fa-pencil bigger-130"></i>
                                                </a>
                                                <a class="red" href="javascript:;" onclick="return del(1);" title="删除">
    ...
    <script>
        function del(id) {
            layer.confirm('你确定要删除吗？', {icon: 3}, function (index) {
                layer.close(index);
                window.location.href = "/admin.php?m=user&a=house_del/del_id/" + id + "";
            });
        }
    </script>
    			<div class="footer">
