                    ...
                    <div class="col-xs-12">
                        <div>
                            <div class="col-xs-12 col-sm-2">
                                <a href="/admin.php?m=user&a=shop_commodity_add">
                            ...
                            <div class="col-xs-5 col-sm-3" style="display:None;">
                                <form name="shop_commodity_list" class="form-search" method="post" action="/admin.php?m=user&a=shop_commodity_list">
                                    <div class="input-group">
                                        <select name="pid" class="col-sm-8">
                                            <option value="" style="margin-right:5px;">全部</option>
                                            <option value="classBox"   style="margin-right:5px;">宝箱</option><option value="classPet"   style="margin-right:5px;">宠物</option><option value="classProp"   style="margin-right:5px;">道具</option><option value="classHot"   style="margin-right:5px;">热销</option><option value="classMaterial"   style="margin-right:5px;">材料</option><option value="classGod"   style="margin-right:5px;">神像</option><option value="classBackground"   style="margin-right:5px;">背景</option><option value="classDogFood"   style="margin-right:5px;">狗粮</option>                                        </select>
                            ...
                            <form id="leftnav" name="leftnav" method="post" action="" >
                                ...
                                <table id="dynamic-table" class="table table-striped table-bordered table-hover">
									...
									<?php if(is_array($info)): foreach($info as $key=>$v): ?><tr>
                                            ...
                                            <td><?php echo ($v["com_identifier"]); ?></td>
                                            <td><?php echo ($v["shop_class"]); ?></td>
                                            <td><img src="/Public/shop_commodity_list/upload_img/<?php echo ($v["id"]); ?>.png" width="50">  </td>
                                           <td><?php echo ($v["com_count"]); ?></td>
                                            <td><?php echo ($v["com_sum"]); ?></td>
                                            <td><?php echo ($v["com_price"]); ?></td>
                                            <td><?php echo ($v["com_info"]); ?></td>
                                            <td><?php echo ($v["com_describe"]); ?></td>

                                            <td>
                                                <div class="hidden-sm hidden-xs action-buttons;display:none;" style="display:None;">
                                                    <a class="green" href="/admin.php?m=user&a=shop_commodity_edit" title="修改">
                                                        <i class="ace-icon fa fa-pencil bigger-130"></i>
                                                    </a>
                                                    <a class="red" href="javascript:;" onclick="return del(5);" title="删除">
                                    ...
                                    <tr>
                                        <td colspan="14" align="right"><div class=pagination><ul>
										<li><span>   </span></li>  
    ...
    <script>
        function del(id) {
            layer.confirm('你确定要删除吗？', {icon: 3}, function (index) {
                layer.close(index);
                window.location.href = "/admin.php?m=user&a=shop_commodity_del&id=" + id + "";
            });
        }
    </script>
    			<div class="footer">
