                    ...
                    <div class="col-xs-12">
                        <div>
                            <div class="col-xs-12 col-sm-2">
                                <a href="/admin.php?m=user&a=land_class_add">
                                    <button class="btn btn-xs btn-info">添加土地类型</button>
                                </a>
                            </div>
                            <form id="leftnav" name="leftnav" method="post" action="" >
                                ...
                                <table id="dynamic-table" class="table table-striped table-bordered table-hover">
									...
									<?php if(is_array($info)): foreach($info as $key=>$v): ?><tr>
                                            <td><?php echo ($v["id"]); ?></td>
                                            <td><?php echo ($v["landclass_name"]); ?></td>
                                            <td><?php echo ($v["landclass_level"]); ?></td>
                                            <td> <img src="/Public/land_class_list/<?php echo ($v["id"]); ?>.png" width="50"></td>
                                            <td><?php echo ($v["landclass_info"]); ?></td>
                                            <td><?php echo ($v["landclass_crops"]); ?></td>
                                            <td>开启</td>
                                        <td>
    ...
    <script>
        function del(id) {
            layer.confirm('你确定要删除吗？', {icon: 3}, function (index) {
                layer.close(index);
                window.location.href = "/admin.php?m=user&a=land_class_del/del_id/" + id + "";
            });
        }
    </script>
