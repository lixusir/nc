            ...
            <div class="page-content">
                <div class="row maintop">
                    <div class="col-xs-12 col-sm-3">
                        <form name="admin_list_sea" class="form-search" method="post" action="/qyadmin.php/Member/member_gold_log_list" style="display:none;">
                    ...
                    <div class="input-group-btn">
                        <a href="/qyadmin.php/Member/member_login_log_list">
