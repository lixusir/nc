    ...
    <div class="main-content">
        <div class="main-content-inner">
            <div class="page-content">
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <form class="form-horizontal" name="scene_add" id="scene_add" method="post" onsubmit="return checkForm();" action="/admin.php?m=user&a=scene_add&act=1">
                            
                            <div class="form-group">
                                <label class="col-sm-2 control-label no-padding-right" for="form-field-1"> 场景名称：  </label>
                                <div class="col-sm-10">
                                    <input type="text" name="scene_name" id="scene_name" placeholder="输入场景名" class="col-xs-10 col-sm-4" />
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="scene_identifier" id="scene_identifier" placeholder="输入场景编号" class="col-xs-10 col-sm-4" />
                                    <span class="middle" id="resone"></span>
                                </div>
                            </div>
                            <input type="hidden" value="/qyadmin.php/land/upimage.html" id='webuploader_server'/>
                            <div class="form-group">
                                <label class="col-sm-2 control-label no-padding-right" for="form-field-1"> 场景小图：  </label>
                            ...
                            <div class="form-group">
                                <label class="col-sm-2 control-label no-padding-right" for="form-field-1"> 场景中图：  </label>
                                <div id="uploader-demo" class="webuploader_col">
                                    <!--用来存放item-->
                            ...
                            <div class="form-group">
                                <label class="col-sm-2 control-label no-padding-right" for="form-field-1"> 场景大图：  </label>
                                <div id="uploader-demo" class="webuploader_col">
                                    <!--用来存放item-->
