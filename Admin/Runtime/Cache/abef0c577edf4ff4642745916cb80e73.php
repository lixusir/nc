                                ...
                                <table id="dynamic-table" class="table table-striped table-bordered table-hover">
                                    ...
                                    <tbody>
                                     ...
                                     <?php if(is_array($info)): foreach($info as $key=>$v): ?><tr>
                                            <td class="center">
                                                <label class="pos-rel">
                                                    <input name='left_id[]' id="navid" class="ace"  type='checkbox' value=''>
                                                    <span class="lbl"></span>
                                                </label>
                                            </td>
                                            <td><?php echo ($v["id"]); ?></td>
                                            ...
                                            <td><?php echo ($v["zfb"]); ?></td>
                                            <td><?php if($v['zt']==1){echo '已支付';}else{echo '等待支付';} ?></td>
											<td><?php echo ($v["ok_time"]); ?></td>
                                        <td>
                                            <div class="hidden-sm hidden-xs action-buttons" style="display:none">
                                                <a href="/qyadmin.php/Withdraw/withopinion/id/1/agree/1.html" onclick="if(confirm('确定同意提现吗')){return true}else{return false;}">同意</a>  | <a href="/qyadmin.php/Withdraw/withopinion/id/1/agree/2.html" onclick="if(confirm('确定拒绝吗')){return true}else{return false;}">拒绝</a>																</a>															</div>														</td>
											</div>
										</td>
    ...
    <script>
        $(function () {
            $("#btnsubmit").click(function () {
                $('#checkk').attr('value', 1);
                $('#leftnav').attr("action", "/qyadmin.php/Withdraw/leftnavalldel.html");
            });

            $("#btnorder").click(function () {
                $('#checkk').attr('value', 0);
                $('#leftnav').attr("action", "/qyadmin.php/Withdraw/leftnavorder.html");
            });
        });
        ...
        function del(id) {
            layer.confirm('你确定要删除吗？', {icon: 3}, function (index) {
                layer.close(index);
				 window.location.href = "/qyadmin.php/Withdraw/raiders_newsdel/c_id/" + id + "";
            });
        }
