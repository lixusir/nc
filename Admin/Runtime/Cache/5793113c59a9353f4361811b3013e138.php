                    ...
                    <div class="col-xs-12">
                        <div>
                            <div class="col-xs-12 col-sm-2">
                                <a href="/admin.php?m=user&a=pet_add">
                                    <button class="btn btn-xs btn-info">添加宠物</button>
                                </a>
                            </div>
                            <form id="leftnav" name="leftnav" method="post" action="" >
                                ...
                                <table id="dynamic-table" class="table table-striped table-bordered table-hover">
									...
									<?php if(is_array($info)): foreach($info as $key=>$v): ?><tr>
                                            <td><?php echo ($v["pet_name"]); ?></td>
                                            <td><?php echo ($v["pet_identifier"]); ?></td>
                                            <td><?php echo ($v["pet_score"]); ?></td>
                                            <td><?php echo ($v["id"]); ?></td>
                                            <td> <img src="/Public/pet_list/<?php echo ($v["id"]); ?>1.gif" width="50"></td>
                                            <td> <img src="/Public/pet_list/<?php echo ($v["id"]); ?>2.gif" width="50"></td>
                                            <td> <img src="/Public/pet_list/<?php echo ($v["id"]); ?>3.png" width="50"></td>
                                            <td><?php echo ($v["pet_attack"]); ?></td>
                                            <td><?php echo ($v["pet_defense"]); ?></td>
                                            <td><?php echo ($v["pet_speed"]); ?></td>
                                            <td><?php echo ($v["pet_luck"]); ?></td>
                                            <td><?php echo ($v["pet_life"]); ?></td>
                                            <td> <?php echo ($v["pet_description"]); ?></td>
                                        <td>
                                            
                                        </td>
                                        </tr><?php endforeach; endif; ?>										
                                    <tr>
                                        <td colspan="14" align="right"><div class=pagination><ul><li><span><?php echo ($page); ?></span></li>          </ul></div></td>
                                    </tr>
                                    </tbody>
                                </table>
                            </form>
    ...
    <script>
        function del(id) {
            layer.confirm('你确定要删除吗？', {icon: 3}, function (index) {
                layer.close(index);
                window.location.href = "/qyadmin.php/Pet/pet_del/del_id/" + id + "";
            });
        }
    </script>
