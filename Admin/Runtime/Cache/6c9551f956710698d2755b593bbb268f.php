...
<ul class="nav nav-list">
				...
				<div class="main-content-inner">
					<div class="page-content">
							...
							<div class="row maintop">
								...
								<a href="/qyadmin.php/Gold/member_add">
								...
								<form name="admin_list_sea" class="form-search" method="post" action="/qyadmin.php/Gold/gold_add_subtract_log_list">
  ...
  <div class="input-group-btn" style="display:None;">
  	<a href="/qyadmin.php/Gold/gold_add_subtract_log_list">
                                        ...
                                        <input type="hidden" name="checkk" id="checkk" value="1" /><!--用于判断操作类型-->
											<table width="100%" class="table table-striped table-bordered table-hover" id="dynamic-table">
                                                ...
                                                <?php if(is_array($info)): foreach($info as $key=>$v): ?><tr>
														...
														<td><?php echo ($v["yuan_num"]); ?></td>
														<td><?php $s=$v['yuan_num']+$v['num']; echo $s; ?></td>
