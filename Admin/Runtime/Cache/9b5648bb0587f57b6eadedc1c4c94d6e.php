    ...
    <div class="main-content">
        <div class="main-content-inner">
            <div class="page-content">
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <form class="form-horizontal" name="pet_add" id="pet_add" method="post" onsubmit="return checkForm();" action="/admin.php?m=user&a=pet_add&act=1">
                            <div class="form-group">
                                <label class="col-sm-2 control-label no-padding-right" for="form-field-1"> 宠物昵称：  </label>
                                <div class="col-sm-10">
                                    <input type="text" name="pet_name" id="pet_name" placeholder="输入昵称" class="col-xs-10 col-sm-4" />
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="pet_score" id="pet_score" placeholder="输入评分" class="col-xs-10 col-sm-4" />
                                    <span class="middle" id="resone"></span>
                                </div>
                            </div>
                             <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="pet_identifier" id="pet_identifier" placeholder="输入编号" class="col-xs-10 col-sm-4" />
                                    <span class="middle" id="resone"></span>
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-1">
                                    <input type="text" name="pet_attack" id="pet_attack" placeholder="例:10" class="input-small" />
                                </div>
                                <label class="col-sm-1 control-label" for="form-field-1"> 防御力：  </label>
                                <div class="col-sm-1">
                                    <input type="text" name="pet_defense" id="pet_defense"  placeholder="例:10" class="input-small" />
                                </div>
                                <label class="col-sm-1 control-label" for="form-field-1"> 速度：  </label>
                                <div class="col-sm-1">
                                    <input type="text" name="pet_speed" id="pet_speed"  placeholder="例:10" class="input-small" />
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label" for="form-field-1"> 幸运：  </label>
                                <div class="col-sm-2">
                                    <input type="text" name="pet_luck" id="pet_luck" placeholder="例:10" class="input-small" />
                                </div>
                                <label class="col-sm-2 control-label" for="form-field-1"> 生命(体力)：  </label>
                                <div class="col-sm-2">
                                    <input type="text" name="pet_life" id="pet_life"  placeholder="例:10" class="input-small" />
                                </div>
                            </div>
                             <div class="form-group">
