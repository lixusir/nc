    ...
    <div class="main-content">
        <div class="main-content-inner">
            <div class="page-content">
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <form class="form-horizontal" name="columnadd" id="columnadd" method="post" action="/admin.php?m=user&a=notice_listadd&act=1">

                            
                            <div class="form-group">
                                <label class="col-sm-2 control-label no-padding-right" for="form-field-1"> 公告标题：  </label>
                                <div class="col-sm-10">
                                    <input type="text" name="notice_title" id="notice_title"  placeholder="必填：公告标题"  class="col-xs-10 col-sm-6"/>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="sort" id="sort"  placeholder="排序"  class="col-xs-10 col-sm-6"/>
                                    <span class="help-inline col-xs-12 col-sm-7">
                                        <span class="middle" id="resone"></span>
                                    </span>
                                </div>
