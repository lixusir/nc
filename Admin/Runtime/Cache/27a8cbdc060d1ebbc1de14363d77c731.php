            ...
            $(document).ready(function () {
                $("#logout").click(function () {
                    layer.confirm('你确定要退出吗？', {icon: 3}, function (index) {
                        layer.close(index);
                        window.location.href = "/admin.php?m=login&a=logout";
                    });
                });
            });
        </script>
    ...
    <div class="main-content">
        <div class="main-content-inner">
            <div class="page-content">
                    ...
                    $(function () {
                        ...
                        function checkForm() {
                            if ('' == $.trim($('#sys_name').val())) {
                                ...
                                $('#resone')('网站名称不能为空').show();//id为resone 赋值html值
                                $('#sys_name').focus();
                                return false;
                            }
                            ...
                            if ('' == $.trim($('#sys_url').val())) {
                                ...
                                $('#resone')('').show();//id为resone 赋值html值
                                $('#restwo')('网址不能为空').show();//id为resone 赋值html值
                                $('#sys_url').focus();
                                return false;
                            }
                        ...
                        function complete(data) {
                            if (data.status == 1) {
                                layer.alert(data.info, {icon: 6}, function (index) {
                                    layer.close(index);
                                    window.location.href = "/admin.php?m=user&a=sys";
                                });
                            } else {
                                alert(data.info);
                                return false;
                ...
                <div class="row">
                    <div class="col-xs-12">
					<?php if(is_array($info)): foreach($info as $key=>$v): ?><form class="form-horizontal" name="sys" id="sys" method="post" action="/admin.php?m=ajax&a=runsys">
                            <input type="hidden" name="sys_id" value="1" />
                            <div class="form-group">
                                <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 站点名称 </label>
                                <div class="col-sm-9">
                                    <input type="text" name="sys_name" id="sys_name" value="<?php echo ($v["sys_name"]); ?>" class="col-xs-10 col-sm-5" />
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name="sys_url" id="sys_url" value="<?php echo ($v["sys_url"]); ?>"  class="col-xs-10 col-sm-5" />
                                    <span class="help-inline col-xs-12 col-sm-7">
                            ...
                            <div class="space-4"></div>
                            <div class="form-group">
                                <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 短信接口账户 </label>
                                <div class="col-sm-9">
                                    <input type="text" name="sys_sms_account" id="sys_sms_account" value="<?php echo ($v["sys_sms_account"]); ?>"  class="col-xs-10 col-sm-5" />
                                    <span class="help-inline col-xs-12 col-sm-7">
                                        <span class="middle" id="restwo"></span>
                                    </span>
                                </div>
                            ...
                            <div class="space-4"></div>
                            <div class="form-group">
                                <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 短信接口密码 </label>
                                <div class="col-sm-9">
                                    <input type="text" name="sys_sms_pass" id="sys_sms_pass" value="<?php echo ($v["sys_sms_pass"]); ?>"  class="col-xs-10 col-sm-5" />
                                    <span class="help-inline col-xs-12 col-sm-7">
                                        <span class="middle" id="restwo"></span>
                                    </span>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name="sys_title" id="sys_title" value="<?php echo ($v["sys_title"]); ?>"  class="col-xs-10 col-sm-5" />
                                    <span class="help-inline col-xs-12 col-sm-7">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <textarea  name="sys_key" cols="20" class="col-xs-10 col-sm-7 limited"  id="form-field-9"  maxlength="100"><?php echo ($v["sys_key"]); ?></textarea>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <textarea  name="sys_des" cols="20" class="col-xs-10 col-sm-7 limitedone"   id="form-field-10"  maxlength="200"><?php echo ($v["sys_des"]); ?></textarea>
                                    <span class="help-inline col-xs-5 col-sm-5">
                            ...
                            <div class="form-group">
                                <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 项目底部 </label>
                                <div class="col-sm-9">
                                    <textarea  name="kind_text"  ><?php echo ($v["kind_text"]); ?></textarea>
                                </div>
                            </div>
                            <div class="space-4"></div>
