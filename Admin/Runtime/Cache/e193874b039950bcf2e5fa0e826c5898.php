    ...
    <div class="main-content">
        <div class="main-content-inner">
            <div class="page-content">
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <form class="form-horizontal" name="shop_commodity_add" id="shop_commodity_add" method="post" onsubmit="return checkForm();" action="/admin.php?m=user&a=shop_commodity_add&act=1">
                            <div class="form-group">
                                <label class="col-sm-2 control-label no-padding-right" for="form-field-1"> 商品名：  </label>
                                <div class="col-sm-10">
                                    <input type="text" name="com_name" id="com_name" placeholder="输入商品名" class="col-xs-10 col-sm-4" />
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="com_identifier" id="com_identifier" placeholder="输入商品编号" class="col-xs-10 col-sm-4" />
                                    <span class="middle" id="resone"></span>
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="com_count" id="com_count" placeholder="商品数量" class="col-xs-10 col-sm-4" />
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label no-padding-right" for="form-field-1"> 商品价格：  </label>
                                <div class="col-sm-10">
                                    <input type="text" name="com_price" id="com_price" placeholder="商品价格" class="col-xs-10 col-sm-4" />
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label no-padding-right" for="form-field-1"> 商品总量：  </label>
                                <div class="col-sm-10">
                                    <input type="text" name="com_sum" id="com_sum" placeholder="商品总量" class="col-xs-10 col-sm-4" />
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label no-padding-right" for="form-field-1"> 道具参数：  </label>
                                <div class="col-sm-10">
                                  <textarea class="form-control" id="com_info" name="com_info" placeholder="输入简短介绍" style="margin: 0px -0.015625px 0px 0px; height: 62px; width: 416px;"></textarea>
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <textarea class="form-control" id="form-field-8" name="com_describe" placeholder="输入简短介绍" style="margin: 0px -0.015625px 0px 0px; height: 62px; width: 416px;"></textarea>
                                </div>
                            </div>
