                ...
                <div class="row maintop">
                    <form class="form-horizontal" name="pet_level_add" id="pet_level_add" method="post" action="/admin.php?m=user&a=pet_add&act=2">
                        <div class="col-xs-12 col-sm-12">
                            ...
                            <small><?php echo ($level); ?><input type='hidden' name='level' value='<?php echo ($level); ?>'></small>
                                ...
                                <table width="100%" class="table table-striped table-bordered table-hover" id="dynamic-table">
                                    ...
                                    <tbody>
                                     <?php if(is_array($info)): foreach($info as $key=>$v): ?><tr>
                                            ...
                                            <td><input name="experience<?php echo ($v["id"]); ?>" id="experience<?php echo ($v["id"]); ?>" value='<?php echo ($v["experience"]); ?>' class="rule"/></td>
                                            <td><input name="life1" id="life<?php echo ($v["id"]); ?>" value='<?php echo ($v["experience"]); ?>' class="rule"/></td>
                                            <td><input name="max_attack<?php echo ($v["id"]); ?>" id="max_attack<?php echo ($v["id"]); ?>" value='<?php echo ($v["max_attak"]); ?>' class="rule"/></td>
                                            <td><input name="max_defense<?php echo ($v["id"]); ?>" id="max_defense1" value='<?php echo ($v["max_defense"]); ?>' class="rule"/></td>
                                            <td><input name="max_speed<?php echo ($v["id"]); ?>" id="max_speed<?php echo ($v["id"]); ?>" value='<?php echo ($v["max_speed"]); ?>' class="rule"/></td>
                                            <td><input name="max_luck<?php echo ($v["id"]); ?>" id="max_luck<?php echo ($v["id"]); ?>" value='<?php echo ($v["max_luck"]); ?>' class="rule"/></td>
                                            <td>
                                                <div class="hidden-sm hidden-xs action-buttons">
                                                    <a class="green" onclick='onSubmit(<?php echo ($v["id"]); ?>)' title="修改">
