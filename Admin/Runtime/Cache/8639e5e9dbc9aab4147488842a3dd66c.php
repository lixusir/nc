    ...
    <div class="main-content">
        <div class="main-content-inner">
            <div class="page-content">
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <form class="form-horizontal" name="admin_list_edit" id="admin_list_edit" method="post" action="/admin.php?m=ajax&a=admin_list_runedit">
                            <input name="admin_id" id="admin_id" type="hidden" value="2" />
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="admin_username" id="admin_username"  value="admin"  class="col-xs-10 col-sm-4" readonly/>
