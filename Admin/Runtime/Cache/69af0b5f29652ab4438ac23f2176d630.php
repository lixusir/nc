            ...
            <div class="page-content">
                <div class="row maintop">
                    <div class="col-xs-12 col-sm-3">
                        <form name="admin_list_sea" class="form-search" method="post" action="/qyadmin.php/Member/member_land_log_list">
                            <div class="input-group">
                                <span class="input-group-addon">
                                    <i class="ace-icon fa fa-check"></i>
                                </span>
                                <input type="text" name="val" id="val" class="form-control search-query admin_sea" value="" placeholder="输入需查询的用户昵称" />
                    ...
                    <div class="input-group-btn">
                        <a href="/qyadmin.php/Member/member_land_log_list">
                            ...
                            <form id="leftnav" name="leftnav" method="post" action="" >
                                ...
                                <table width="100%" class="table table-striped table-bordered table-hover" id="dynamic-table">
									...
									<?php if(is_array($info)): foreach($info as $key=>$v): ?><tr>
                                            <td height="28" ><?php echo ($v["nickname"]); ?></td>
                                            <td><?php echo ($v["landid"]); ?></td>
                                            <td><?php echo ($v["landtype"]); ?></td>
                                            <td><?php echo ($v["zuowu"]); ?></td>
                                            <td><?php echo ($v["des"]); ?></td>
                                            <td><?php echo ($v["time"]); ?></td>
                                        </tr><?php endforeach; endif; ?>	
										
                                    <tr>
                                        <td height="50" colspan="10" align="left"><div class=pagination><ul>
