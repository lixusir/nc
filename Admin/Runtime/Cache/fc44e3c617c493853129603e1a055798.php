                    ...
                    <div class="col-xs-12">
                        <div>
                            <div class="col-xs-12 col-sm-2">
                                <a href="/admin.php?m=user&a=scene_add">
                                    <button class="btn btn-xs btn-info">添加场景</button>
                                </a>
                            </div>
                            <form id="leftnav" name="leftnav" method="post" action="" >
                                ...
                                <table id="dynamic-table" class="table table-striped table-bordered table-hover">
									...
									<?php if(is_array($info)): foreach($info as $key=>$v): ?><tr>
                                            ...
                                            <td><?php echo ($v["scene_identifier"]); ?></td>
                                            <td> <img src="/Public/scene_list/<?php echo ($v["id"]); ?>.png" width="50"></td>
                                            <td> <img src="/Public/scene_list/<?php echo ($v["id"]); ?>.png" width="50"></td>
                                            <td> <img src="/Public/scene_list/<?php echo ($v["id"]); ?>.png" width="50"></td>
    ...
    <script>
        function del(id) {
            layer.confirm('你确定要删除吗？', {icon: 3}, function (index) {
                layer.close(index);
                window.location.href = "/admin.php?m=user&a=scene_del/del_id/" + id + "";
            });
        }
    </script>
