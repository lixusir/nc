				...
				<div class="main-content-inner">
					<div class="page-content">
							...
							<div class="row maintop">
								...
								<form name="admin_list_sea" class="form-search" method="post" action="/admin.php?m=user&a=member_login_log_list">
                                        ...
                                        <input type="hidden" name="checkk" id="checkk" value="1" /><!--用于判断操作类型-->
											<table width="100%" class="table table-striped table-bordered table-hover" id="dynamic-table">
                                                ...
                                                <?php if(is_array($info)): foreach($info as $key=>$v): ?><tr>
                                                  ...
                                                  <tr>
													  <td height="50" colspan="10" align="left"><div class=pagination>
													  <ul>
...
function del(id){
	...
	layer.close(index);
	window.location.href="/admin.php?m=user&a=admin_list_del/member_id/"+id+"";
	});
}

function stateyes(val){
		  $.post('/admin.php?m=user&a=member_list_state.html',
		  {x:val},
	function(data){
	var $v=val;
		if(data.status){
