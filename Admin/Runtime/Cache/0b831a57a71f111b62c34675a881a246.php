                    ...
                    <div class="col-xs-12">
                        <div>
                            <div class="col-xs-12 col-sm-2">
                                <a href="/qyadmin.php/Raiders/raiders_columnadd">
                                    <button class="btn btn-xs btn-info">添加类型</button>
                                </a>
                            </div>
                            <form id="leftnav" name="leftnav" method="post" action="" >
                                ...
                                <table id="dynamic-table" class="table table-striped table-bordered table-hover">
                                    ...
                                    <tr>
                                            <td class="center">
                                                <label class="pos-rel">
                                                    <input name='left_id[]' id="navid" class="ace"  type='checkbox' value='8'>
                                                    <span class="lbl"></span>
                                                </label>
                                            </td>

                                            <td >打赏阅读</span> <strong>(ID：8)</strong></td>
                                        <td>开启</td>
                                        <td><input name="8" value=" 50" class="list_order"/></td>
                                        <td>
                                            <div class="hidden-sm hidden-xs action-buttons">
                                                
                                                <a class="green" href="/qyadmin.php/Raiders/raiders_columnedit/c_id/8.html" title="修改">
                                                    <i class="ace-icon fa fa-pencil bigger-130"></i>
                                                </a>
                                                <a class="red" href="javascript:;" onclick="return del(8);" title="删除">
                                            ...
                                            <td class="center">
                                                <label class="pos-rel">
                                                    <input name='left_id[]' id="navid" class="ace"  type='checkbox' value='10'>
                                                    <span class="lbl"></span>
                                                </label>
                                            </td>

                                            <td >免费阅读</span> <strong>(ID：10)</strong></td>
                                        <td>开启</td>
                                        <td><input name="10" value=" 50" class="list_order"/></td>
                                        <td>
                                            <div class="hidden-sm hidden-xs action-buttons">
                                                
                                                <a class="green" href="/qyadmin.php/Raiders/raiders_columnedit/c_id/10.html" title="修改">
                                                    <i class="ace-icon fa fa-pencil bigger-130"></i>
                                                </a>
                                                <a class="red" href="javascript:;" onclick="return del(10);" title="删除">
                                                    <i class="ace-icon fa fa-trash-o bigger-130"></i>
                                                </a>
                                            </div>
                                        </td>
    ...
    <script>
        ...
        function del(id) {
            layer.confirm('你确定要删除吗？', {icon: 3}, function (index) {
                layer.close(index);
                window.location.href = "/qyadmin.php/Raiders/raiders_columndel/c_id/" + id + "";
            });
        }
