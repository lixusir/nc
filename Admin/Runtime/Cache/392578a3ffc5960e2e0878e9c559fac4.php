    ...
    <div class="main-content">
        <div class="main-content-inner">
            <div class="page-content">
                ...
                <div class="row">
                    <div class="col-xs-12">
					<?php if(is_array($info)): foreach($info as $key=>$v): ?><form class="form-horizontal" name="columnadd" id="columnadd" method="post" action="/admin.php?m=user&a=raiders_listedit&act=1&id=<?php echo ($v["id"]); ?>">
                            <input type="hidden" name="news_id" value="<?php echo ($v["id"]); ?>">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="news_name" id="news_name"  value="<?php echo ($v["news_name"]); ?>" placeholder="必填：文章标题"  class="col-xs-10 col-sm-6"/>
                                    <span class="help-inline col-xs-12 col-sm-7">
                                        <span class="middle" id="resone"></span>
                                    </span>
                                </div>
                            </div>
							<input type="hidden" name="reward" id="reward" value="0" />
							<input type="hidden" name="news_label" id="news_label" value="11,12" />							
                            <div class="space-4"></div>
                            <!-- <div class="form-group"> -->
                                <!-- <label class="col-sm-2 control-label no-padding-right" for="form-field-1"> 文章标题(EN)：  </label> -->
                                <!-- <div class="col-sm-10"> -->
                                    <!-- <input type="text" name="news_enname" id="news_name" value=""  placeholder="必填：文章标题(EN)"  class="col-xs-10 col-sm-6"/> -->
                                    <!-- <span class="help-inline col-xs-12 col-sm-7"> -->
                                        <!-- <span class="middle" id="resone"></span> -->
                                    <!-- </span> -->
                                <!-- </div> -->
