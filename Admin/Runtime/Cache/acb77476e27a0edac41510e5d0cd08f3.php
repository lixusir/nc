    ...
    <div class="main-content">
        <div class="main-content-inner">
            <div class="page-content">
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <form class="form-horizontal" name="crops_add" id="crops_add" method="post" onsubmit="return checkForm();" action="/admin.php?m=user&a=crops_add&act=1">
                            
                            <div class="form-group">
                                <label class="col-sm-2 control-label no-padding-right" for="form-field-1"> 农作物名称：  </label>
                                <div class="col-sm-10">
                                    <input type="text" name="crops_name" id="crops_name" placeholder="输入农作物名" class="col-xs-10 col-sm-4" />
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="crops_identifier" id="crops_identifier" placeholder="输入农作物编号" class="col-xs-10 col-sm-4" />
                                    <span class="middle" id="resone"></span>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="crops_land_count" id="crops_land_count" placeholder="输入数量" class="col-xs-10 col-sm-4" />
                                    <span class="middle" id="resone"></span>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="crops_harvest" id="crops_harvest" placeholder="输入农作物产量" class="col-xs-10 col-sm-4" />
                                    <span class="middle" id="resone"></span>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="crops_probability" id="crops_probability" placeholder="输入概率数量" class="col-xs-10 col-sm-4" />
                                    <span class="middle" id="resone"></span>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="crops_seed" id="crops_seed" placeholder="种子生长周期(小时)" class="col-xs-10 col-sm-4" />
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label no-padding-right" for="form-field-1"> 发芽期：  </label>
                                <div class="col-sm-10">
                                    <input type="text" name="crops_sprout" id="crops_sprout" placeholder="发芽生长周期(小时)" class="col-xs-10 col-sm-4" />
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label no-padding-right" for="form-field-1"> 生长期：  </label>
                                <div class="col-sm-10">
                                    <input type="text" name="crops_grow" id="crops_grow" placeholder="生长期周期(小时)" class="col-xs-10 col-sm-4" />
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label no-padding-right" for="form-field-1"> 开盘价：  </label>
                                <div class="col-sm-10">
                                    <input type="text" name="crops_open_price" id="crops_open_price" placeholder="开盘价" class="col-xs-10 col-sm-4" />
                                </div>
                            </div>							
                            ...
                            <div class="form-group">
                                ...
                                <div id="uploader-demo" class="webuploader_col">
                                    ...
                                    <input type="hidden" value="" id="uploader_file" name="uploader_file"/>
                            ...
                            <div class="form-group">
                                ...
                                <div id="uploader-demo" class="webuploader_col">
                                    ...
                                    <input type="hidden" value="" id="uploader_file1" name="uploader_file1"/>
                            ...
                            <div class="form-group">
                                ...
                                <div id="uploader-demo" class="webuploader_col">
                                    ...
                                    <input type="hidden" value="" id="uploader_file2" name="uploader_file2"/>
                            ...
                            <div class="form-group">
                                ...
                                <div id="uploader-demo" class="webuploader_col">
                                    ...
                                    <input type="hidden" value="" id="uploader_file3" name="uploader_file3"/>
