                    ...
                    <div class="col-xs-12">
                        <div>
                            <div class="col-xs-12 col-sm-2">
                                <a href="/admin.php?m=user&a=crops_add">
                                    <button class="btn btn-xs btn-info">添加农作物</button>
                                </a>
                            </div>
                                ...
                                <table id="dynamic-table" class="table table-striped table-bordered table-hover">
                                    <thead>
                                        <tr>
                                            ...
                                            <th width="5%">开盘价</th>
<!--                                            <th width="8%">状态</th>-->
                                            <th width="15%" style="border-right:#CCC solid 1px;">操作</th>
                                        </tr>
                                    </thead>
                                    <tbody>
									<?php if(is_array($info)): foreach($info as $key=>$v): ?><tr>
                                            <td><?php echo ($v["id"]); ?></td>
                                            <td><?php echo ($v["crops_identifier"]); ?></td>
                                            <td><?php echo ($v["crops_name"]); ?></td>
                                            <td> <img src="/Public/crops_list/<?php echo ($v["id"]); ?>1.png" width="50"></td>
                                            <td> <img src="/Public/crops_list/<?php echo ($v["id"]); ?>2.png" width="50"></td>
                                            <td> <img src="/Public/crops_list/<?php echo ($v["id"]); ?>3.png" width="50"></td>
                                            <td> <img src="/Public/crops_list/<?php echo ($v["id"]); ?>4.png" width="50"></td>
                                            <td><?php echo ($v["crops_land_count"]); ?></td>
                                            <td><?php echo ($v["crops_probability"]); ?></td>
                                            <td><?php echo ($v["crops_harvest"]); ?></td>
                                            <td><?php echo ($v["crops_seed"]); ?></td>
                                            <td><?php echo ($v["crops_sprout"]); ?></td>
                                            <td><?php echo ($v["crops_grow"]); ?></td>
                                            <td><?php echo ($v["crops_open_price"]); ?></td>
<!--                                            <td>开启</td>-->
                                        <td>
                                <a class="green" href="/admin.php?m=user&a=crops_list_edit&id=<?php echo ($v["id"]); ?>" title="修改">
    ...
    <script>
        function del(id) {
            layer.confirm('你确定要删除吗？', {icon: 3}, function (index) {
                layer.close(index);
                window.location.href = "/admin.php?m=user&a=crops_del/del_id/" + id + "";
            });
        }
    </script>
    			<div class="footer">
