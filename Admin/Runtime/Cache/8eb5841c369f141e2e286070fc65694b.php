    ...
    <div class="main-content">
        <div class="main-content-inner">
            <div class="page-content">
                ...
                <div class="row">
                    <div class="col-xs-12">
					<?php if(is_array($info)): foreach($info as $key=>$v): ?><form class="form-horizontal" name="columnadd" id="columnadd" method="post" action="/admin.php?m=user&a=notice_listedit&act=1&id=<?php echo ($v["id"]); ?>">

                            <input type="hidden" name="id" value="6">
                            <div class="form-group">
                                <label class="col-sm-2 control-label no-padding-right" for="form-field-1"> 公告标题：  </label>
                                <div class="col-sm-10">
                                    <input type="text" name="notice_title" id="notice_title"  value="<?php echo ($v["title"]); ?>"  class="col-xs-10 col-sm-6"/>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="sort" id="sort"  value="<?php echo ($v["sort"]); ?>"  class="col-xs-10 col-sm-6"/>
                                    <span class="help-inline col-xs-12 col-sm-7">
                                        <span class="middle" id="resone"></span>
                                    </span>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10" style="padding-top:5px;">
                                    <input name="notice_display" id="news_open" value="1" class="ace ace-switch ace-switch-4 btn-flat" checked type="checkbox" />
                            ...
                            <div class="form-group">
                                <label class="col-sm-2 control-label no-padding-right" for="form-field-1"> 公告主内容 </label>
                                <div class="col-sm-10">
                                    <textarea  name="kind_text"><?php echo ($v["content"]); ?></textarea>
                                </div>
                            </div>
                            <div class="space-4"></div>
    ...
    $(function () {
        ...
        function checkForm() {
            if ('' == $.trim($('#notice_title').val())) {
                ...
                $('#resone').html('标题不能为空').show();//id为resone 赋值html值
                $('#notice_title').focus();
                return false;
            }
        }
