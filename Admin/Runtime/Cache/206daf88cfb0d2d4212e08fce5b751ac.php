    ...
    <div class="main-content">
        <div class="main-content-inner">
            <div class="page-content">
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <form class="form-horizontal" name="admin_list_add"  method="post" action="<?php echo U('Admin/add');?>">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="username" id="username" placeholder="输入登录用户名" class="col-xs-10 col-sm-4" />
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="password" id="password" placeholder="输入登录密码" class="col-xs-10 col-sm-4" />
                            ...
                            <div class="form-group">
                                <label class="col-sm-2 control-label no-padding-right" for="form-field-1"> 确认管理员密码  </label>
                                <div class="col-sm-10">
                                    <input type="text" name="pwd" id="pwd" placeholder="确认管理员密码" class="col-xs-10 col-sm-4" />
                                    <span class="lbl">&nbsp;&nbsp;<span class="red">*</span>请再次确认管理员密码</span>
                                </div>
                            </div>
                            <div class="space-4"></div>
