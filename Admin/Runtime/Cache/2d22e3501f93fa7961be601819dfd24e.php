    ...
    <div class="main-content">
        <div class="main-content-inner">
            <div class="page-content">
                ...
                <script>
                    function checkForm() {
                        if ('' == $.trim($('#class_name').val())) {
                            ...
                            $('#resone').html('商品类型名不能为空').show();//id为resone 赋值html值
                            $('#class_name').focus();
                            return false;
                        }
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <form class="form-horizontal" name="shop_class_add" id="shop_class_add" method="post" onsubmit="return checkForm();" action="/admin.php?m=user&a=shop_class_add&act=1">
                            <div class="form-group">
                                <label class="col-sm-2 control-label no-padding-right" for="form-field-1"> 商品类型名：  </label>
                                <div class="col-sm-10">
                                    <input type="text" name="class_name" id="class_name" placeholder="输入商品类型" class="col-xs-10 col-sm-4" />
                                    <span class="middle" id="resone"></span>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label no-padding-right" for="form-field-1"> 类型编号：  </label>
                                <div class="col-sm-10">
                                    <input type="text" name="class_identifier" id="class_identifier" placeholder="输入类型编号" class="col-xs-10 col-sm-4" />
                                </div>
                            </div>
                            <div class="form-group">
