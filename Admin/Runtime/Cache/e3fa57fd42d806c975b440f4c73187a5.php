...
<ul class="nav nav-list">
        ...
        <li class="active open"><!--open代表打开状态-->
                ...
                <ul class="submenu">
                                        <li class="">
                            <a href="/admin.php?m=user&a=Withdraw_list">
                                <i class="menu-icon fa fa-caret-right"></i>
                                已处理                            </a>
                            <b class="arrow"></b>
                        </li><li class="">
                            <a href="/admin.php?m=user&a=Withdraw_apply">
                                <i class="menu-icon fa fa-caret-right"></i>
                                未处理                            </a>
                            <b class="arrow"></b>
                        </li>                    <!--
        ...
        <div class="main-content-inner">
            <div class="page-content">
                ...
                <script>
                    $(function () {
                        function checkForm() {
                            if ('' == $.trim($('#crops_name').val())) {
                                $('#resone').attr("class", "middle highmsg");//ID为resone 重新class赋值
                                $('#resone').html('农作物名不能为空').show();//id为resone 赋值html值
                                $('#crops_name').focus();
                                return false;
                            }
                        }
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <form class="form-horizontal" name="crops_edit" id="crops_edit" method="post" onsubmit="return checkForm();" action="/qyadmin.php/Land/crops_edit">
                            <div class="form-group">
                                <label class="col-sm-2 control-label no-padding-right" for="form-field-1"> 农作物名称：  </label>
                                <div class="col-sm-10">
                                    <input type="text" name="crops_name" id="crops_name" value="核桃" placeholder="输入农作物名" class="col-xs-10 col-sm-4" />
                                    <input type='hidden' name='edit_id' value='2'>
                                    <span class="middle" id="resone"></span>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label no-padding-right" for="form-field-1"> 农作物编号：  </label>
                                <div class="col-sm-10">
                                    <input type="text" name="crops_identifier" id="crops_identifier" value="plantingApple" placeholder="输入农作物编号" class="col-xs-10 col-sm-4" />
                                    <span class="middle" id="resone"></span>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label no-padding-right" for="form-field-1"> 需要开垦土地数量：  </label>
                                <div class="col-sm-10">
                                    <input type="text" name="crops_land_count" id="crops_land_count" value="0" placeholder="输入数量" class="col-xs-10 col-sm-4" />
                                    <span class="middle" id="resone"></span>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label no-padding-right" for="form-field-1"> 农作物产量：  </label>
                                <div class="col-sm-10">
                                    <input type="text" name="crops_harvest" id="crops_harvest" value="50-80" placeholder="输入农作物产量" class="col-xs-10 col-sm-4" />
                                    <span class="middle" id="resone"></span>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label no-padding-right" for="form-field-1"> 生长概率：  </label>
                                <div class="col-sm-10">
                                    <input type="text" name="crops_probability" id="crops_probability" value="10" placeholder="输入概率数量" class="col-xs-10 col-sm-4" />
                                    <span class="middle" id="resone"></span>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label no-padding-right" for="form-field-1"> 种子期：  </label>

                                <div class="col-sm-10">
                                    <input type="text" name="crops_seed" id="crops_seed" value="0.5" placeholder="种子生长周期(小时)" class="col-xs-10 col-sm-4" />
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label no-padding-right" for="form-field-1"> 发芽期：  </label>
                                <div class="col-sm-10">
                                    <input type="text" name="crops_sprout" id="crops_sprout" value="5.5" placeholder="发芽生长周期(小时)" class="col-xs-10 col-sm-4" />
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label no-padding-right" for="form-field-1"> 生长期：  </label>
                                <div class="col-sm-10">
                                    <input type="text" name="crops_grow" id="crops_grow" value="9.0" placeholder="生长期周期(小时)" class="col-xs-10 col-sm-4" />
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label no-padding-right" for="form-field-1"> 开盘价：  </label>
                                <div class="col-sm-10">
                                    <input type="text" name="crops_open_price" id="crops_open_price" value="1.00" placeholder="生长期周期(小时)" class="col-xs-10 col-sm-4" />
                                </div>
                            </div>							
                            <input type="hidden" value="/qyadmin.php/land/upimage.html" id='webuploader_server'/>
                            <div class="form-group">
                                <label class="col-sm-2 control-label no-padding-right" for="form-field-1"> 农产品(发芽)：  </label>
                                <div id="uploader-demo" class="webuploader_col">
                                    <!--用来存放item-->
                                    <div id="fileList" class="uploader-list">
                                        <div class="file-item upload-state-done">
                                            <img src="/Public/UploadFiles_s/2017-06-13/593f4987c6a7a.png" width="100">
                                        </div>
                                    </div>
                                    <input type="hidden" value="2017-06-13/593f4987c6a7a.png" id="uploader_file" name="uploader_file"/>
                                    <div id="filePicker">选择图片</div>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label no-padding-right" for="form-field-1"> 农产品(生长)：  </label>
                                <div id="uploader-demo" class="webuploader_col">
                                    <!--用来存放item-->
                                    <div id="fileList1" class="uploader-list">
                                        <div class="file-item upload-state-done">
                                            <img src="/Public/UploadFiles_s/2017-06-13/593f499579387.png" width="100">
                                        </div> 
                                    </div>
                                    <input type="hidden" value="2017-06-13/593f499579387.png" id="uploader_file1" name="uploader_file1"/>
                                    <div id="filePicker1">选择图片</div>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label no-padding-right" for="form-field-1"> 农产品(成熟)：  </label>
                                <div id="uploader-demo" class="webuploader_col">
                                    <!--用来存放item-->
                                    <div id="fileList2" class="uploader-list">
                                        <div class="file-item upload-state-done">
                                            <img src="/Public/UploadFiles_s/2017-06-13/593f49999ef11.png" width="100">
                                        </div> 
                                    </div>
                                    <input type="hidden" value="2017-06-13/593f49999ef11.png" id="uploader_file2" name="uploader_file2"/>
                                    <div id="filePicker2">选择图片</div>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label no-padding-right" for="form-field-1"> 果实：  </label>
                                <div id="uploader-demo" class="webuploader_col">
                                    <!--用来存放item-->
                                    <div id="fileList3" class="uploader-list">
                                        <div class="file-item upload-state-done">
                                            <img src="/Public/UploadFiles_s/2017-06-13/593f499ba27ce.png" width="100">
                                        </div> 
                                    </div>
                                    <input type="hidden" value="2017-06-13/593f499ba27ce.png" id="uploader_file3" name="uploader_file3"/>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10" style="padding-top:5px;">
                                    <input name="display" id="display" value="1" class="ace ace-switch ace-switch-4 btn-flat" checked type="checkbox" />
                                    <span class="lbl">&nbsp;&nbsp;</span>
                                </div>
                            </div>
