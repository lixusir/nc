                    ...
                    <div class="col-xs-12">
                        <div>
                            <div class="col-xs-12 col-sm-2">
                                <a href="/qyadmin.php/Raiders/raiders_labeladd">
                                    <button class="btn btn-xs btn-info">添加标签</button>
                                </a>
                            </div>
                            <form id="leftnav" name="leftnav" method="post" action="" >
                                ...
                                <table id="dynamic-table" class="table table-striped table-bordered table-hover">
                                    ...
                                    <tr>
                                            <td class="center">
                                                <label class="pos-rel">
                                                    <input name='left_id[]' id="navid" class="ace"  type='checkbox' value='11'>
                                                    <span class="lbl"></span>
                                                </label>
                                            </td>

                                            <td >赚钱</span> <strong>(ID：11)</strong></td>
                                        <td>开启</td>
                                        <td><input name="11" value=" 50" class="list_order"/></td>
                                        <td>
                                            <div class="hidden-sm hidden-xs action-buttons">
                                                
                                                <a class="green" href="/qyadmin.php/Raiders/raiders_labeledit/c_id/11.html" title="修改">
                                                    <i class="ace-icon fa fa-pencil bigger-130"></i>
                                                </a>
                                                <a class="red" href="javascript:;" onclick="return del(11);" title="删除">
                                            ...
                                            <td class="center">
                                                <label class="pos-rel">
                                                    <input name='left_id[]' id="navid" class="ace"  type='checkbox' value='12'>
                                                    <span class="lbl"></span>
                                                </label>
                                            </td>

                                            <td >新手</span> <strong>(ID：12)</strong></td>
                                        <td>开启</td>
                                        <td><input name="12" value=" 50" class="list_order"/></td>
                                        <td>
                                            <div class="hidden-sm hidden-xs action-buttons">
                                                
                                                <a class="green" href="/qyadmin.php/Raiders/raiders_labeledit/c_id/12.html" title="修改">
                                                    <i class="ace-icon fa fa-pencil bigger-130"></i>
                                                </a>
                                                <a class="red" href="javascript:;" onclick="return del(12);" title="删除">
                                                    <i class="ace-icon fa fa-trash-o bigger-130"></i>
                                                </a>
                                            </div>
                                        </td>
                                            ...
                                            <td class="center">
                                                <label class="pos-rel">
                                                    <input name='left_id[]' id="navid" class="ace"  type='checkbox' value='13'>
                                                    <span class="lbl"></span>
                                                </label>
                                            </td>

                                            <td >稳定</span> <strong>(ID：13)</strong></td>
                                        <td>开启</td>
                                        <td><input name="13" value=" 50" class="list_order"/></td>
                                        <td>
                                            <div class="hidden-sm hidden-xs action-buttons">
                                                
                                                <a class="green" href="/qyadmin.php/Raiders/raiders_labeledit/c_id/13.html" title="修改">
                                                    <i class="ace-icon fa fa-pencil bigger-130"></i>
                                                </a>
                                                <a class="red" href="javascript:;" onclick="return del(13);" title="删除">
                                                    <i class="ace-icon fa fa-trash-o bigger-130"></i>
                                                </a>
                                            </div>
                                        </td>
                                            ...
                                            <td class="center">
                                                <label class="pos-rel">
                                                    <input name='left_id[]' id="navid" class="ace"  type='checkbox' value='14'>
                                                    <span class="lbl"></span>
                                                </label>
                                            </td>

                                            <td >经验</span> <strong>(ID：14)</strong></td>
                                        <td>开启</td>
                                        <td><input name="14" value=" 50" class="list_order"/></td>
                                        <td>
                                            <div class="hidden-sm hidden-xs action-buttons">
                                                
                                                <a class="green" href="/qyadmin.php/Raiders/raiders_labeledit/c_id/14.html" title="修改">
                                                    <i class="ace-icon fa fa-pencil bigger-130"></i>
                                                </a>
                                                <a class="red" href="javascript:;" onclick="return del(14);" title="删除">
                                                    <i class="ace-icon fa fa-trash-o bigger-130"></i>
                                                </a>
                                            </div>
                                        </td>
                                    ...
                                    <tr>
                                        <td colspan="2" align="left"><button  id="btnorder" class="btn btn-white btn-yellow btn-sm">排序</button></td>
                                        <td colspan="3"></td>
                                    </tr>
                                    </tbody>
                                </table>
    ...
    <script>
        ...
        function del(id) {
            layer.confirm('你确定要删除吗？', {icon: 3}, function (index) {
                layer.close(index);
                window.location.href = "/qyadmin.php/Raiders/raiders_labeldel/c_id/" + id + "";
            });
        }
