    ...
    <div class="main-content">
        <div class="main-content-inner">
            <div class="page-content">
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <form class="form-horizontal" name="land_class_add" id="land_class_add" method="post" onsubmit="return checkForm();" action="/admin.php?m=user&a=land_class_add&act=1">
                            <div class="form-group">
                                <label class="col-sm-2 control-label no-padding-right" for="form-field-1"> 土地类型名：  </label>
                                <div class="col-sm-10">
                                    <input type="text" name="landclass_name" id="landclass_name" placeholder="输入土地名" class="col-xs-10 col-sm-4" />
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="landclass_level" id="landclass_level" placeholder="输入土地等级" class="col-xs-10 col-sm-4" />
                                    <span class="middle" id="resone"></span>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                  <textarea class="form-control" id="landclass_info" name="landclass_info" placeholder="输入参数信息" style="margin: 0px -0.015625px 0px 0px; height: 62px; width: 416px;"></textarea>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label no-padding-right" for="form-field-1"> 可生产农作物：  </label>
                                <div class="col-sm-10">
                                    <input type="text" name="landclass_crops" id="landclass_crops" placeholder="农作物id，农作物id" class="col-xs-10 col-sm-4" />
                                </div>
                            </div>
                            <div class="form-group">
