    ...
    <div class="main-content">
        <div class="main-content-inner">
            <div class="page-content">
                    ...
                    $(function () {
                        function checkForm() {
                            if ('' == $.trim($('#com_name').val())) {
                                ...
                                $('#resone').html('商品名不能为空').show();//id为resone 赋值html值
                                $('#crops_name').focus();
                                return false;
                            }
                        }
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <form class="form-horizontal" name="shop_commodity_edit" id="shop_commodity_edit" method="post" onsubmit="return checkForm();" action="/qyadmin.php/Shop/shop_commodity_edit">
                            <div class="form-group">
                                <label class="col-sm-2 control-label no-padding-right" for="form-field-1"> 商品名：  </label>
                                <div class="col-sm-10">
                                    <input type="text" name="com_name" id="com_name" placeholder="输入商品名" value="种子" class="col-xs-10 col-sm-4" />
                                    <input type='hidden' name='edit_id' value='5'>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="com_identifier" id="com_identifier" value="comSeed" placeholder="输入商品编号" class="col-xs-10 col-sm-4" />
                                    <span class="middle" id="resone"></span>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label no-padding-right" for="form-field-1"> 推荐位置：  </label>
                                <div class="col-sm-10">
                                     <select class="col-sm-3" id="shop_class" name="shop_class">
                                        <option value="classHot" selected>热销 classHot</option><option value="classProp" >道具 classProp</option><option value="classBox" >宝箱 classBox</option><option value="classPet" >宠物 classPet</option><option value="classMaterial" >材料 classMaterial</option><option value="classGod" >神像 classGod</option><option value="classBackground" >背景 classBackground</option><option value="classDogFood" >狗粮 classDogFood</option>                                    </select>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="com_count" id="com_count" placeholder="商品数量" value="1000" class="col-xs-10 col-sm-4" />
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label no-padding-right" for="form-field-1"> 商品价格：  </label>
                                <div class="col-sm-10">
                                    <input type="text" name="com_price" id="com_price" placeholder="商品价格" value="1561" class="col-xs-10 col-sm-4" />
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label no-padding-right" for="form-field-1"> 商品总量：  </label>
                                <div class="col-sm-10">
                                    <input type="text" name="com_sum" id="com_sum" placeholder="商品总量" value="999000" class="col-xs-10 col-sm-4" />
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label no-padding-right" for="form-field-1"> 道具参数：  </label>
                                <div class="col-sm-10">
                                  <textarea class="form-control" id="com_info" name="com_info" placeholder="" style="margin: 0px -0.015625px 0px 0px; height: 62px; width: 416px;"></textarea>
                                </div>
                            </div>
                            <input type="hidden" value="/qyadmin.php/land/upimage.html" id='webuploader_server'/>
                            <div class="form-group">
                                <label class="col-sm-2 control-label no-padding-right" for="form-field-1"> 商品图：  </label>
                                <div id="uploader-demo" class="webuploader_col">
                                    <!--用来存放item-->
                                    <div id="fileList" class="uploader-list">
                                        <div class="file-item upload-state-done">
                                            <img src="/Public/UploadFiles_s/2017-06-07/5937711a9b0c6.png" width="100">
                                        </div> 
                                    </div>
                                    <input type="hidden" value="2017-06-07/5937711a9b0c6.png" id="uploader_file" name="uploader_file"/>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <textarea class="form-control" id="form-field-8" name="com_describe" placeholder="输入简短介绍" style="margin: 0px -0.015625px 0px 0px; height: 62px; width: 416px;">     迷一样的种子，不知道种下去，得到的是什么。</textarea>
                                </div>
                            </div>
                            <div class="form-group">
