            ...
            <div class="page-content">
                ...
                <script>
                    $(function () {
                        ...
                        function checkForm() {
                            ...
                            if ('' == $.trim($('#admin_list_edit').val())) {
                                //layer.alert('会员昵称不能为空', {icon: 1}, function (index) {
                                    layer.close(index);
                                    $('#admin_list_edit').focus();
                                });
                                return false;
                            }
                ...
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        <form class="form-horizontal" name="admin_list_edit" id="" method="post" action="/admin.php?m=user&a=crops_list_edit&act=1&id=<?php echo ($id); ?>">
                            <input name="member_id" id="member_id" type="hidden" value="6" />
                            <input name="member_tel_hidden" id="member_tel_hidden" type="hidden" value="<?php echo ($v[""]); ?>" />

                            <div class="form-group">
                                <label class="col-sm-2 control-label no-padding-right" for="form-field-1"> 产量  </label>
                                <div class="col-sm-10">
                                    <input type="text" name="crops_harvest" id="crops_harvest" placeholder="" value="<?php echo ($crops_harvest); ?>" class="col-xs-10 col-sm-4" />
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="crops_seed" id="crops_seed" placeholder="" value="<?php echo ($crops_seed); ?>"  class="col-xs-10 col-sm-4" />
                                    <span class="lbl">&nbsp;&nbsp;<span class="red">*</span></span>
                                </div>
                            </div>
                            <div class="space-4"></div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="crops_sprout" id="crops_sprout" placeholder="" value="<?php echo ($crops_sprout); ?>" class="col-xs-10 col-sm-4" />
                                    <span class="lbl">&nbsp;&nbsp;<span class="red">*</span></span>
                                </div>
                            </div>
                            <div class="space-4"></div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="crops_grow" id="crops_grow" placeholder="" value="<?php echo ($crops_grow); ?>"  class="col-xs-10 col-sm-4" />
                                    <span class="lbl">&nbsp;&nbsp;</span>
                                </div>
                            </div>
