    ...
    <div class="main-content">
        <div class="main-content-inner">
            <div class="page-content">
                ...
                <script>
                    function checkForm() {
                        if ('' == $.trim($('#landclass_name').val())) {
                            $('#resone').attr("class", "middle highmsg");//ID为resone 重新class赋值
                            $('#resone').html('土地类型名不能为空').show();//id为resone 赋值html值
                            $('#landclass_name').focus();
                            return false;
                        }
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <form class="form-horizontal" name="land_class_edit" id="land_class_edit" method="post"  enctype="multipart/from-data" onsubmit="return checkForm();" action="/qyadmin.php/Land/land_class_edit">
                            <div class="form-group">
                                <label class="col-sm-2 control-label no-padding-right" for="form-field-1"> 土地类型名：  </label>
                                <div class="col-sm-10">
                                    <input type="text" name="landclass_name" id="landclass_name" value="盐碱地" placeholder="输入土地类型名" class="col-xs-10 col-sm-4" />
                                    <input type='hidden' name='edit_id' value='2'>
                                    <span class="middle" id="resone"></span>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label no-padding-right" for="form-field-1"> 土地等级：  </label>
                                <div class="col-sm-10">
                                    <input type="text" name="landclass_level" id="landclass_level"  value="2" placeholder="输入土地等级" class="col-xs-10 col-sm-4" />
                                    <span class="middle" id="resone"></span>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label no-padding-right" for="form-field-1"> 土地参数：  </label>
                                <div class="col-sm-10">
                                  <textarea class="form-control" id="landclass_info" name="landclass_info" placeholder="输入参数信息" style="margin: 0px -0.015625px 0px 0px; height: 62px; width: 416px;">{"crops":"8:150;2:150","diamond":"200"}</textarea>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label no-padding-right" for="form-field-1"> 可生产农作物：  </label>
                                <div class="col-sm-10">
                                    <input type="text" name="landclass_crops" id="landclass_crops" value="2,8,9,10" placeholder="农作物id，农作物id" class="col-xs-10 col-sm-4" />
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label no-padding-right" for="form-field-1"> 土地图片：  </label>
                                <div id="uploader-demo" class="webuploader_col">
                                    <!--用来存放item-->
                                    <div id="fileList" class="uploader-list">
                                        <div class="file-item upload-state-done">
                                            <img src="/Public/UploadFiles_s/2017-06-13/593f8d21643ec.png" width="100">
                                        </div> 
                                    </div>
                                    <input type="hidden" value="/qyadmin.php/land/upimage.html" id='webuploader_server'/>
                                    <input type="hidden" value="2017-06-13/593f8d21643ec.png" id="uploader_file" name="uploader_file"/>
