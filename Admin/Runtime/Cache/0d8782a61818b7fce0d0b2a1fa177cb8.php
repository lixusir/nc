    ...
    <div class="main-content">
        <div class="main-content-inner">
            <div class="page-content">
                ...
                <script>
                    $(function () {
                        ...
                        $('#rePwd').click(function () {
                            ...
                            $.ajax({
                                type: "POST",
                                url: "/qyadmin.php/Member/member_reset_pwd.html",
                ...
                <div class="row">
                    <div class="col-xs-12">
					<?php if(is_array($info)): foreach($info as $key=>$v): ?><form class="form-horizontal" name="admin_list_edit" id="admin_list_edit" method="post" action="/admin.php?m=user&a=member_list_edit&act=1&id=<?php echo ($v["id"]); ?>">
                            <input name="member_id" id="member_id" type="hidden" value="6" />
                            <input name="member_tel_hidden" id="member_tel_hidden" type="hidden" value="<?php echo ($v["username"]); ?>" />

                            <div class="form-group">
                                <label class="col-sm-2 control-label no-padding-right" for="form-field-1"> 登录手机号：  </label>
                                <div class="col-sm-10">
                                    <input type="text" name="member_tel" id="member_tel" placeholder="输入登录手机号" value="<?php echo ($v["username"]); ?>" class="col-xs-10 col-sm-4" />
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="member_realname" id="member_realname" placeholder="输入真实姓名" value="<?php echo ($v["realname"]); ?>"  class="col-xs-10 col-sm-4" />
                                    <span class="lbl">&nbsp;&nbsp;<span class="red">*</span></span>
                                </div>
                            </div>
                            <div class="space-4"></div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="member_nickname" id="member_nickname" placeholder="输入会员昵称" value="<?php echo ($v["nickname"]); ?>" class="col-xs-10 col-sm-4" />
                                    <span class="lbl">&nbsp;&nbsp;<span class="red">*</span></span>
                                </div>
                            </div>
                            <div class="space-4"></div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="member_mynum" id="member_mynum" placeholder="输入推荐码" value="<?php echo ($v["upxianid"]); ?>" readonly class="col-xs-10 col-sm-4" />
                                    <span class="lbl">&nbsp;&nbsp;</span>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="member_idcard" id="member_idcard" placeholder="输入证件号码" value="<?php echo ($v["idcard"]); ?>" readonly class="col-xs-10 col-sm-4" />
                                    <span class="lbl">&nbsp;&nbsp;</span>
                                </div>
                            </div>
							<div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="gold" id="gold" placeholder="" value="<?php echo ($v["gold"]); ?>"  class="col-xs-10 col-sm-4" />
                                    <span class="lbl">&nbsp;&nbsp;</span>
                                </div>
                            </div>
							<div class="form-group">
                                <label class="col-sm-2 control-label no-padding-right" for="form-field-1"> 钻石  </label>
                                <div class="col-sm-10">
                                    <input type="text" name="zs" id="zs" placeholder="" value="<?php echo ($v["zs"]); ?>"  class="col-xs-10 col-sm-4" />
                                    <span class="lbl">&nbsp;&nbsp;</span>
                                </div>
                            </div>
							<div class="form-group">
                                <label class="col-sm-2 control-label no-padding-right" for="form-field-1"> 会员等级  </label>
                                <div class="col-sm-10">
                                    <input type="text" name="lvl" id="lvl" placeholder="" value="<?php echo ($v["lvl"]); ?>"  class="col-xs-10 col-sm-4" />
                                    <span class="lbl">&nbsp;&nbsp;</span>
                                </div>
                            </div>
							<div class="form-group">
                                <label class="col-sm-2 control-label no-padding-right" for="form-field-1"> 房屋等级  </label>
                                <div class="col-sm-10">
                                    <input type="text" name="fangwu" id="fangwu" placeholder="" value="<?php echo ($v["fangwu"]); ?>"  class="col-xs-10 col-sm-4" />
                                    <span class="lbl">&nbsp;&nbsp;</span>
                                </div>
                            </div>
                                ...
                                <button class="btn btn-info" type="submit" style="text-align:center">
