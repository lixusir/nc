    ...
    <div class="main-content">
        <div class="main-content-inner">
            <div class="page-content">
                    ...
                    $(function () {
                        ...
                        function checkForm() {
                            ...
                            if ('' == $.trim($('#member_tel').val())) {
                                layer.alert('目标电话不能为空', {icon: 6}, function (index) {
                                    layer.close(index);
                                    $('#member_tel').focus();
                                });
                                return false;
                            ...
                            if (!telRet.test($('#member_tel').val())) {
                                layer.alert('目标电话格式不正确，请重新输入', {icon: 6}, function (index) {
                                    layer.close(index);
                                    $('#member_tel').focus();
                                });
                                return false
                            ...
                            if ('' == $.trim($('#gold_type option:selected').val())) {
                                layer.alert('请选择操作类型', {icon: 6}, function (index) {
                                    layer.close(index);
                                    $('#gold_type').focus();
                                });
                                return false;
                            ...
                            if ('' == $.trim($('#gold_property option:selected').val())) {
                                layer.alert('请选择操作物品', {icon: 6}, function (index) {
                                    layer.close(index);
                                    $('#gold_property').focus();
                                });
                                return false;
                            ...
                            if ('' == $.trim($('#gold_coins').val())) {
                                layer.alert('金币数量不能为空', {icon: 6}, function (index) {
                                    layer.close(index);
                            ...
                            if (!goldCoins.test($('#gold_coins').val())) {
                                layer.alert('数量填写错误', {icon: 6}, function (index) {
                                    layer.close(index);
                                    $('#gold_coins').focus();
                                });
                                return false
                ...
                <div class="row">
                    <div class="col-xs-12">
		 <!--form class="form-horizontal" name="admin_list_add" id="admin_list_add" method="post" action="/admin.php?m=user&a=gold_add_subtract&act=1"-->

                        <form class="form-horizontal" name="admin_list_add" id="" method="post" action="/admin.php?m=user&a=gold_add_subtract&act=1">

                            <div class="form-group">
                                <label class="col-sm-2 control-label no-padding-right" for="form-field-1"> 目标会员名或手机：  </label>
                                <div class="col-sm-10">
                                    <input type="text" name="member_tel" id="member_tel" placeholder="输入目标会员名或手机：" class="col-xs-10 col-sm-4" />
                            ...
                            <div class="form-group">
                                <label class="col-sm-2 control-label no-padding-right" for="form-field-1"> 执行操作：  </label>
                                <div class="col-sm-10">
                                    <select name="gold_type" id="gold_type" class="col-sm-4" >
                                        <option value="">请选择操作类型</option>

                                        <option name="type" value="1">增加</option>
                                        <option name="type" value="2">减少</option>
                            ...
                            <!-- 修改 -->
                            <div class="form-group">
                                <label class="col-sm-2 control-label no-padding-right" for="form-field-1"> 操作物品：  </label>
                                <div class="col-sm-10">
                                    <select name="gold_property" id="gold_property" class="col-sm-4" >
                                        <option value="">请选择操作物品</option>

                                        <option value="coins">金币</option>
                                        <option value="diamond">钻石</option>
                                        <option value="2">核桃</option>
										<option value="8">石榴</option>
										<option value="9">红枣</option>
										<option value="10">葡萄</option>
										<option value="14">哈密瓜</option>
										<option value="15">香梨</option>
										<option value="16">沙漠果</option>
										<option value="17">人参果</option>
										<option value="18">薰衣草</option>
										<option value="19">沙漠人参</option>
										<option value="20">巴旦木</option>
										<option value="21">和田玉</option>                                    </select>
                                </div>
                            </div>
                            <div class="space-4"></div>

                            <div class="form-group">
                                <label class="col-sm-2 control-label no-padding-right" for="form-field-1"> 填写数量：  </label>
                                <div class="col-sm-10">
                                    <input type="text" name="gold_coins" id="gold_coins" placeholder="输入数量" class="col-xs-10 col-sm-4" />
                                    <span class="lbl">&nbsp;&nbsp;<span class="red">*</span></span>
                                </div>
                            </div>
                            <div class="space-4"></div>
