                    ...
                    <div class="col-xs-12">
                        <div>
                            <div class="col-xs-12 col-sm-2">
                                <a href="/admin.php?m=user&a=shop_class_add">
                                    <button class="btn btn-xs btn-info">添加商品类型</button>
                                </a>
                            </div>
                            <form id="leftnav" name="leftnav" method="post" action="" >
                                ...
                                <table id="dynamic-table" class="table table-striped table-bordered table-hover">
									...
									<?php if(is_array($info)): foreach($info as $key=>$v): ?><tr>
                                            ...
                                            <td><?php echo ($v["class_identifier"]); ?></td>
                                            <td>开启</td>
                                            <td><?php echo ($v["add_time"]); ?></td>
                                        <td>
                                            <div class="hidden-sm hidden-xs action-buttons" style="display:none">
                                                <a class="green" href="/admin.php?m=user&a=shop_class_edit&id=<?php echo ($v["id"]); ?>" title="修改">
                                    ...
                                    <tr>
                                        <td colspan="9" align="right"><div class=pagination><ul><li><span>  </span></li>          </ul></div></td>
                                    </tr>
                                    </tbody>
                                </table>
                            </form>
    ...
    <script>
        function del(id) {
            layer.confirm('你确定要删除吗？', {icon: 3}, function (index) {
                layer.close(index);
                window.location.href = "/admin.php?m=user&a=shop_class_del&id=" + id + "";
            });
        }
    </script>
