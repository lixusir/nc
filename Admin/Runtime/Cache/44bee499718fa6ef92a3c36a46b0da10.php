        ...
        <div class="main-content-inner">
            <div class="page-content">
                ...
                <script>
                    $(function () {
                        function checkForm() {
                            if ('' == $.trim($('#scene_name').val())) {
                                $('#resone').attr("class", "middle highmsg");//ID为resone 重新class赋值
                                $('#resone').html('场景名不能为空').show();//id为resone 赋值html值
                                $('#scene_name').focus();
                                return false;
                            }
                        }
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <form class="form-horizontal" name="scene_edit" id="scene_edit" method="post" onsubmit="return checkForm();" action="/qyadmin.php/Land/scene_edit">
                            <div class="form-group">
                                <label class="col-sm-2 control-label no-padding-right" for="form-field-1"> 场景名称：  </label>
                                <div class="col-sm-10">
                                    <input type="text" name="scene_name" id="scene_name" value="场景1" placeholder="输入场景名" class="col-xs-10 col-sm-4" />
                                    <input type='hidden' name='edit_id' value='1'>
                                    <span class="middle" id="resone"></span>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label no-padding-right" for="form-field-1"> 场景编号：  </label>
                                <div class="col-sm-10">
                                    <input type="text" name="scene_identifier" id="scene_identifier" value="comBgone" placeholder="输入场景编号" class="col-xs-10 col-sm-4" />
                                    <span class="middle" id="resone"></span>
                                </div>
                            </div>							
                            <input type="hidden" value="/qyadmin.php/land/upimage.html" id='webuploader_server'/>
                            <div class="form-group">
                                <label class="col-sm-2 control-label no-padding-right" for="form-field-1"> 小图：  </label>
                                <div id="uploader-demo" class="webuploader_col">
                                    <!--用来存放item-->
                                    <div id="fileList" class="uploader-list">
                                        <div class="file-item upload-state-done">
                                            <img src="/Public/UploadFiles_s/2017-07-03/595a117f0639a.png" width="100">
                                        </div>
                                    </div>
                                    <input type="hidden" value="2017-07-03/595a117f0639a.png" id="uploader_file" name="uploader_file"/>
                                    <div id="filePicker">选择图片</div>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label no-padding-right" for="form-field-1"> 中图：  </label>
                                <div id="uploader-demo" class="webuploader_col">
                                    <!--用来存放item-->
                                    <div id="fileList1" class="uploader-list">
                                        <div class="file-item upload-state-done">
                                            <img src="/Public/UploadFiles_s/2017-07-03/595a118270dca.png" width="100">
                                        </div> 
                                    </div>
                                    <input type="hidden" value="2017-07-03/595a118270dca.png" id="uploader_file1" name="uploader_file1"/>
                            ...
                            <div class="form-group">
                                ...
                                <div id="uploader-demo" class="webuploader_col">
                                    ...
                                    <div id="fileList2" class="uploader-list">
                                        <div class="file-item upload-state-done">
                                            <img src="/Public/UploadFiles_s/2017-07-03/595a11868e22d.jpg" width="100">
                                        </div> 
                                    </div>
                                    <input type="hidden" value="2017-07-03/595a11868e22d.jpg" id="uploader_file2" name="uploader_file2"/>
