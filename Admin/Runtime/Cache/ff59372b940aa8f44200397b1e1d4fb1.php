    ...
    <div class="main-content">
        <div class="main-content-inner">
            <div class="page-content">
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <form class="form-horizontal" name="head_add" id="head_add" method="post" onsubmit="return checkForm();" action="/admin.php?m=user&a=member_head_add&act=1">
                            <div class="form-group">
                                <label class="col-sm-2 control-label no-padding-right" for="form-field-1"> 头像名：  </label>
                                <div class="col-sm-10">
                                    <input type="text" name="head_name" id="head_name" placeholder="输入头像名" class="col-xs-10 col-sm-4" />
                            ...
                            <div class="form-group">
                                <label class="col-sm-2 control-label no-padding-right" for="form-field-1"> 头像样式：  </label>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <textarea class="form-control" id="form-field-8" name="head_description" placeholder="输入简短介绍" style="margin: 0px -0.015625px 0px 0px; height: 62px; width: 416px;"></textarea>
                                </div>
                            </div>
                            <input type="hidden" value="/qyadmin.php/member/upimage.html" id='webuploader_server'/>
