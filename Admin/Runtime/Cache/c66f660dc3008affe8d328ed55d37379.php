                                ...
                                <table id="dynamic-table" class="table table-striped table-bordered table-hover">
                                    ...
                                    <tbody>
									 <?php if(is_array($info)): foreach($info as $key=>$v): ?><tr>
                                            <td class="center">
                                                <label class="pos-rel">
                                                    <input name='left_id[<?php echo ($v["id"]); ?>]' id="navid" class="ace"  type='checkbox' value=''>
                                                    <span class="lbl"></span>
                                                </label>
                                            </td>
                                            <td><?php echo ($v["id"]); ?></td>
                                            ...
                                            <td>申请中</td>
											<td><?php echo ($v["dh_time"]); ?></td>
                                        <td>
                                            <div class="hidden-sm hidden-xs action-buttons">
                                                <a href="/admin.php?m=user&a=okpay&id=<?php echo ($v["id"]); ?>&act=1" onclick="if(confirm('确定同意提现吗')){return true}else{return false;}">同意</a> 
												| <a href="/admin.php?m=user&a=okpay&id=<?php echo ($v["id"]); ?>&act=2" onclick="if(confirm('确定拒绝吗')){return true}else{return false;}">拒绝</a>																</a>															</div>														</td>
											</div>
										</td>
